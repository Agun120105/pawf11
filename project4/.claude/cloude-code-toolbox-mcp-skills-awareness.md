...
_Generated: 2026-06-25T11:37:19.035Z_
...
Workspace `mcp.json` _(folder: project4)_

- **c:\Users\Lina\Downloads\project4\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Lina\.claude.json** — _File exists — no servers defined_
